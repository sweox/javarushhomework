...
public class Space
{
    ...
    public List<BaseObject> getAllItems()
    {
        ...
        ArrayList<BaseObject> listBaseObject = new ArrayList<>();
        listBaseObject.addAll(bombs);
        listBaseObject.addAll(ufos);
        listBaseObject.addAll(rockets);
        listBaseObject.add(ship);
