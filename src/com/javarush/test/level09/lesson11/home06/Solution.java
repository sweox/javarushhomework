...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        woodman.killed.add(wolf); //дровосук убил волка
    }
...
/**
wolf переменная типа Wolf

public static Wolf wolf = new Wolf();

//============================================

Тип Wolf, он же класс Wolf, расширенный (созданный на основе) класс от класса StoryItem

public static class Wolf extends StoryItem

//==============================================

        В классе StoryItem содержиться два списка killed и ate, которые наследуют все классы созданные на основе
 StoryItem, то есть тот же класс Wolf.
...
//===============================================
    ...
    В результате обьект wolf обращается к списку ate и с помощью метода add добавляет значение в список.

    Вроде бы как то так. Может где то и ошибся с терминологией, но думаю ответ понятен.
 */