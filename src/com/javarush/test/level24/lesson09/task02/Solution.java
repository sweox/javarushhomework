    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                int tmp = ((String)stock1.get("name")).compareTo((String)stock2.get("name"));
                if (tmp == 0) {
                    tmp = ((Date)stock2.get("date")).compareTo((Date)stock1.get("date"));
                    if (tmp == 0) {
                        tmp = (!(stock2.containsKey("change")) ? (Double)
                                ((Double)stock2.get("last") - (Double)stock2.get("open") ) :
                                ( (Double)stock2.get("change") ))
                                .compareTo(stock1.containsKey("change") ?
                                        (Double)stock1.get("change") :
                                        ( (Double)((Double)stock1.get("last") - (Double)stock1.get("open"))));
                    }
                }
                return tmp;
            }
...
//                Double tmp1;
//                Double tmp2;
//                tmp1 = !stock1.containsKey("change") ? Double.valueOf((Double) stock1.get("last") - (Double) stock1.get("open")) : (Double) stock1.get("change");
//                if (stock2.containsKey("change")) {
//                    tmp2 = (Double)stock2.get("change");
//                }
//                else
//                    tmp2 = (Double)stock2.get("last") - (Double)stock2.get("open");
