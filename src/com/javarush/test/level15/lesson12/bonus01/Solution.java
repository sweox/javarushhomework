...
3.3. Если параметр равен "plane", то считать второй параметр типа int, статическому объекту
...
public class Solution {
    ...
    public static void reset() {
        //add your code here - добавьте код тут
        //Так почему-то не принимало!!!!!
        BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
        try
        {
            String cons = reader.readLine();
            if (cons.equals("helicopter")) {
                result = new Helicopter();
            }

            if (cons.equals("plane"))
                result = new Plane(Integer.parseInt(cons));
            reader.close();
        }
