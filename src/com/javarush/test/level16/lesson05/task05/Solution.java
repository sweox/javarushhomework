    ...
    public static class Cat extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                kitten1.join();
                kitten2.join();
                /*Надо изменить метод run для кошки (в классе Cat). Надо чтобы котята не оказались
            в корзинке, до того как вылезут, т.е. поставить джоины после вызова метода initAllKitten().*/
