...
/* Поговорим о музыке?
1. Измените класс Violin так, чтоб он стал таском для нити. Используйте интерфейс
MusicalInstrument
...
public class Solution {
    ...
    public static class Violin implements MusicalInstrument {
        ...
        public void run() {
            long dStart = startPlaying().getTime();
            sleepNSeconds(1);
            long dStop = stopPlaying().getTime();
            System.out.println("Playing " + (dStop - dStart) + " ms");
        }
    }
